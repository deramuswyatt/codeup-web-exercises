...
//  */
// console.log(randomColor + (analyzeColor));
// /**
//  * TODO:
...
/* ########################################################################## */
// let color = prompt('what is the color of your choosing?');
//
// switch(color){
//     case "red":
//         alert(color + " is the color of hot sauce!");
//         break;
//     case "orange":
//         alert(color + ' is the color of a particular fruit.');
//         break;
//     case "yellow":
//         alert(color + " is the color of the sun.");
//         break;
//     case "green":
//         alert(color + " is the color of tree leaves.");
//         break;
//     case "blue":
//         alert(color + " is the color of the sky.");
//         break;
//     case "indigo":
//         alert(color + " is a mixture between blue and purple.");
//         break;
//     case "violet":
//         alert(color + " is a shade of purple.");
//         break;
//     default:
//         alert(color + " this is not a color");
//
//
// }
...
// prompt ("What is your total bill?" + (calculateTotal(luckyNumber)));
...
function isNumber(evenOrOdd, plus100, negOrPos) {



    if (evenOrOdd === userInput % 2 == 0) {
        alert("The number" + evenOrOdd + " is even.")
    }else {
    }
    if plus100 ===
}
